...
using fantasy_bachelor.API.Infrastructure.Authentication;
...
namespace fantasy_bachelor.API
{
  public partial class Startup
  {
    public static void ConfigureAuthServices(IConfiguration Configuration, IServiceCollection services)
    {
      ...
      services.AddDbContext<FantasyBachelorContext>(options
      ...
      services.AddIdentity<ApplicationUser, ApplicationRole>(opts =>
      {
        ...
        opts.User.RequireUniqueEmail = true;
          ...
          .AddEntityFrameworkStores<FantasyBachelorContext>().AddDefaultTokenProviders();
    }
