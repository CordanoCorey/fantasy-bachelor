...
namespace fantasy_bachelor.Entity.Extensions
{
  public static class Extensions
  {
    //public static IEnumerable<TEntity> GetHistory<TEntity>(this FantasyBachelorContext context, int id) where TEntity : class
    //{
